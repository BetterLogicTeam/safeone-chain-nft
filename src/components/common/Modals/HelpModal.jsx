        ...
        <div className="fixed inset-0 flex items-center justify-center z-50">
          ...
          >
            <div className="bg-black rounded-lg px-4 pb-6 relative flex flex-col items-center">
              ...
              <h2 className="font-medium -mt-5 uppercase tracking-wider text-lg">NFT that can be staked</h2>

              <div className="p-4 px-12 md:px-0 rounded-md flex flex-col items-center max-w-xl mx-auto text-sm uppercase gap-6">
                <div className="flex flex-col items-center text-center space-y-4 w-full">
                  <div className="container-blue py-2 px-6 w-full cursor-pointer">
                    safo
                  </div>
